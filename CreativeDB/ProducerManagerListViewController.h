//
//  ProducerManagerListViewController.h
//  CreativeDB
//
...
@interface ProducerManagerListViewController : BaseManagerListViewController <NSTableViewDelegate, NSTableViewDataSource>
