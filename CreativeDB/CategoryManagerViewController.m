...
@property (nonatomic, strong) CategoryManagerView *viewInstance;
...
- (id)initWithOptions:(NSDictionary *)options;
{
    ...
    if (self) {
        ...
        self.view = self.viewInstance = [[CategoryManagerView alloc] init];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(updateView:)
                                                     name:CATEGORY_MANAGER_UPDATE_VIEW object:nil];
...
{
    CategoryModel *item = [notification.userInfo objectForKey:MLE_FIELDSET_MODEL_ITEM];
...
- (void) updateList
{
    [[NSNotificationCenter defaultCenter] postNotificationName:CATEGORY_MANAGER_UPDATE_LIST
                                                        object:self
                                                      userInfo:nil];
