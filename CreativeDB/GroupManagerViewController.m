...
@property (nonatomic, strong) GroupManagerView *viewInstance;
...
- (id)initWithOptions:(NSDictionary *)options;
{
    ...
    if (self) {
        ...
        self.view = self.viewInstance = [[GroupManagerView alloc] init];
...
- (void) updateList
{
    [[NSNotificationCenter defaultCenter] postNotificationName:GROUP_MANAGER_UPDATE_LIST
                                                        object:self
                                                      userInfo:nil];
