//
//  CategoryManagerListViewController.h
//  CreativeDB
//
...
@interface CategoryManagerListViewController : BaseManagerListViewController <NSTableViewDelegate, NSTableViewDataSource>
