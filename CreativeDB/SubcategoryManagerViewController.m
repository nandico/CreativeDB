//
//  SubcategoryManagerViewController.m
//  CreativeDB
//
...
@interface SubcategoryManagerViewController ()

@property (nonatomic, strong) SubcategoryManagerView *viewInstance;
@property (nonatomic, strong) NSDictionary *options;

@end

@implementation SubcategoryManagerViewController
...
- (id)initWithOptions:(NSDictionary *)options;
{
    ...
    if (self) {
        ...
        self.view = self.viewInstance = [[SubcategoryManagerView alloc] init];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(updateView:)
                                                     name:SUBCATEGORY_MANAGER_UPDATE_VIEW object:nil];
...
{
    SubcategoryModel *item = [notification.userInfo objectForKey:MLE_FIELDSET_MODEL_ITEM];
...
- (void) updateList
{
    [[NSNotificationCenter defaultCenter] postNotificationName:SUBCATEGORY_MANAGER_UPDATE_LIST
                                                        object:self
                                                      userInfo:nil];
