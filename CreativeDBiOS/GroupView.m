...
- (void) updateData
{
    GroupModel *selectedGroup = [self.dataSource selectedGroup];
    
    if( !selectedGroup ) return;
    
    self.thumb.userInitials.text = [self.thumb extractInitials:selectedGroup.name];
    self.name.text = selectedGroup.name;
    
    
    self.country.text = selectedGroup.country.name;
    self.flag.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@.png", [selectedGroup.country.iso lowercaseString] ]];
    
    self.globalStats.text = @"GLOBAL";
    self.globalScore.text = [NSString stringWithFormat:@"%@", [self addSuffixToNumber:[selectedGroup.rankingGlobal longValue]]];
    
    self.countryStats.text = @"COUNTRY";
    self.countryScore.text = [NSString stringWithFormat:@"%@", [self addSuffixToNumber:[selectedGroup.rankingCountry longValue]]];
