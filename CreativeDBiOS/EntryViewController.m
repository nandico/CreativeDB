...
@property (strong, nonatomic) EntryView *viewInstance;
...
- (void) loadView
{
    self.view = self.viewInstance = [[EntryView alloc] initWithFrame:CONTENT_LANDSCAPE_FRAME];
}
...
- (void) updateData:(NSNotification *) notification
{
    ...
    self.selectedEntry = [notification.userInfo objectForKey:NOTIFICATION_ITEM];
