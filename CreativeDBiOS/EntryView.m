...
- (void) updateData
{
    EntryModel *selectedEntry = [self.dataSource selectedEntry];
    
    if( !selectedEntry ) return;
    
    self.thumb.userInitials.text = [self.thumb extractInitials:selectedEntry.name];
    self.name.text = selectedEntry.name;
    self.country.text = selectedEntry.country.name;
    self.flag.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@.png", [selectedEntry.country.iso lowercaseString] ]];
    
    self.globalStats.text = @"GLOBAL";
    self.globalScore.text = [NSString stringWithFormat:@"%@", [self addSuffixToNumber:[selectedEntry.rankingGlobal longValue]]];
    
    self.countryStats.text = @"COUNTRY";
    self.countryScore.text = [NSString stringWithFormat:@"%@", [self addSuffixToNumber:[selectedEntry.rankingCountry longValue]]];
