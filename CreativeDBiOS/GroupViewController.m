...
@property (strong, nonatomic) GroupView *viewInstance;
...
- (void) loadView
{
    self.view = self.viewInstance = [[GroupView alloc] initWithFrame:CONTENT_LANDSCAPE_FRAME];
}
...
- (void) updateData:(NSNotification *) notification
{
    ...
    self.selectedGroup = [notification.userInfo objectForKey:NOTIFICATION_ITEM];
...
- (void) updateEntries
{
    ...
    for( EntryModel *entry in _selectedGroup.entries )
    {
