...
@property (strong, nonatomic) ClientView *viewInstance;
...
- (void) loadView
{
    self.view = self.viewInstance = [[ClientView alloc] initWithFrame:CONTENT_LANDSCAPE_FRAME];
}
...
- (void) updateData:(NSNotification *) notification
{
    ...
    self.selectedClient = [notification.userInfo objectForKey:NOTIFICATION_ITEM];
...
- (void) updateEntries
{
    ...
    for( EntryModel *entry in _selectedClient.entries )
    {
