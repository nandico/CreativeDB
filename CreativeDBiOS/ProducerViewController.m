...
@property (strong, nonatomic) ProducerView *viewInstance;
...
- (void) loadView
{
    self.view = self.viewInstance = [[ProducerView alloc] initWithFrame:CONTENT_LANDSCAPE_FRAME];
}
...
- (void) updateData:(NSNotification *) notification
{
    ...
    self.selectedProducer = [notification.userInfo objectForKey:NOTIFICATION_ITEM];
    
    if( self.selectedProducer )
    {
        [self removeData];
...
- (void) updateEntries
{
    ...
    for( EntryModel *entry in _selectedProducer.entries )
    {
