...
@property (strong, nonatomic) AgencyView *viewInstance;
...
- (void) loadView
{
    self.view = self.viewInstance = [[AgencyView alloc] initWithFrame:CONTENT_LANDSCAPE_FRAME];
}
...
{
    self.selectedAgency = [notification.userInfo objectForKey:NOTIFICATION_ITEM];
